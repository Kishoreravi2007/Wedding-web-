    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 text-slate-900">
      <div className="flex min-h-screen flex-col">
        ...
        <main className="mx-auto flex w-full max-w-6xl flex-1 flex-col justify-center px-4 py-10 sm:px-6 lg:px-8">
          <div className="grid gap-10 rounded-3xl bg-white p-8 shadow-xl border border-slate-200 md:grid-cols-[1.1fr_1fr]">
            {/* Left Section: Info */}
            <section className="space-y-6 text-left hidden md:block">
              <h1 className="text-4xl font-semibold leading-tight text-slate-900 md:text-5xl">
                Join our elite network of wedding professionals.
              </h1>
              <p className="text-lg text-slate-600">
                Create your profile to showcase your work, manage bookings, and connect with couples looking for the perfect wedding services.
              </p>
            ...
            <section className="space-y-6">
              <div className="text-center space-y-4">
                <img src="/logo.png" alt="WeddingWeb Logo" className="mx-auto h-16 w-16 object-contain mb-2 rounded-2xl" />
                <div className="space-y-1">
                  <h2 className="text-3xl font-semibold text-slate-900 tracking-tight">Create your account</h2>
                </div>
              </div>
              ...
              <form className="space-y-6" onSubmit={startSignupFlow}>
                ...
                <div className="flex flex-col items-center justify-center space-y-3 pb-2">
                  <div className="relative group">
                    ...
                    <label
                      ...
                      className="absolute bottom-0 right-0 p-1.5 bg-white rounded-full shadow-lg border border-slate-100 cursor-pointer text-slate-500 hover:text-rose-500 hover:scale-110 transition-all"
                      title="Upload photo"
                    >
                    ...
                    <AnimatePresence>
                      {showSuggestions && locationSuggestions.length > 0 && (
                        <motion.div
                          ...
                          exit={{ opacity: 0, y: -10 }}
                          className="absolute z-50 left-0 right-0 mt-2 bg-white border border-slate-200 rounded-xl shadow-xl overflow-hidden max-h-[200px] overflow-y-auto"
                        >
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    rows={2}
                    className="bg-white text-slate-900 placeholder:text-slate-400 min-h-[80px]"
                  />
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="signup-password" title="Enter a strong password" className="text-slate-700">
                  ...
                  <div>
                    <Label htmlFor="confirm-password" title="Verify your password" className="text-slate-700">
                      Confirm Password<span className="ml-1 text-rose-500">*</span>
                    </Label>
                    <div className="relative">
                      <Input
                        id="confirm-password"
                        ...
                        className="bg-white text-slate-900 placeholder:text-slate-400 pr-10 rounded-xl"
                        required
                      />
                      <button
                        type="button"
                ...
                <Button
                  type="submit"
                  className="w-full bg-gradient-to-r from-rose-500 via-purple-500 to-indigo-600 text-white font-semibold tracking-wide shadow-lg hover:shadow-xl hover:scale-[1.01] transition-all h-12 rounded-xl"
              ...
              <p className="text-center text-sm text-slate-600">
                ...
                <Link to="/company/login" className="text-rose-500 font-medium hover:text-rose-600 underline-offset-2">
                  Login here
                </Link>
              </p>
            </section>
